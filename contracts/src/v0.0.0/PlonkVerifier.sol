...
contract PlonkVerifier {
  ...
  uint256 private constant VK_QL_COM_X = 19662113583893675610967150156110949869048914320506861061055483124762002458822;
  uint256 private constant VK_QL_COM_Y = 9080457853115586380671391692923205031858410200860335036529361542370403844818;
  uint256 private constant VK_QR_COM_X = 14965255070121487919837550113695382115766471485239151368112678531935595990345;
  uint256 private constant VK_QR_COM_Y = 9278902646365956403094261713926451934767223465618416847259939135637780700283;
  uint256 private constant VK_QM_COM_X = 11054457983027152183768789826982394896898255569879872226570614017590980075572;
  uint256 private constant VK_QM_COM_Y = 731733888661703515509420321943827177494785439340113009605458170588801505804;
  uint256 private constant VK_QO_COM_X = 15332025428564778842656141408285340596518834692676655505919080097377334112716;
  uint256 private constant VK_QO_COM_Y = 20074391908360578400181312869283954284836221144491191804828088932550995914962;
  uint256 private constant VK_QK_COM_X = 16955538579171895246637036596946975817466964012576788318836731712743755933979;
  uint256 private constant VK_QK_COM_Y = 18868589744744666909193391822928360765390108496339284667743828967500499202949;
  
  uint256 private constant VK_S1_COM_X = 13838977323375175256677066751812791211068391099376556139813970274494377485894;
  uint256 private constant VK_S1_COM_Y = 16695953719652946871778853538837315298366739272052723215075755406493904217074;
  
  uint256 private constant VK_S2_COM_X = 5102980713701442313448974581919989052991257824805392448352974514619237559918;
  uint256 private constant VK_S2_COM_Y = 19984809580524086099180892976028101387958668843570698752393572626542068382347;
  
  uint256 private constant VK_S3_COM_X = 9393919237678860818218948991409351020771243571988110385239128976609577715106;
  uint256 private constant VK_S3_COM_Y = 7135399868967672983804085971012470807202761670861198313819514068555267192063;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 17814574994381197184397348120658542189036000001071017896244110575863352597840;
  uint256 private constant VK_QCP_0_Y = 9921013512260776990063339084781889177920747918513840481748393670447977624884;
  
  
  uint256 private constant VK_INDEX_COMMIT_API_0 = 22086493;
