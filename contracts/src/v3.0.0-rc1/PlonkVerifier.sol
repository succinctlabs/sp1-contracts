...
contract PlonkVerifier {
    ...
    uint256 private constant VK_QL_COM_X =
        3290060728869345335154114718977447053330166483334167631366198142610428232620;
    uint256 private constant VK_QL_COM_Y =
        19162119719409246272115813094185025995857052458470900198554531144420657384429;
    uint256 private constant VK_QR_COM_X =
        20593285675028444864919533759061889592214551177771462207774701990433512561961;
    uint256 private constant VK_QR_COM_Y =
        2037190768409221720866644069987363251819987312430306430360685249062434970888;
    uint256 private constant VK_QM_COM_X =
        3243698466425196128341517132303061662197275421453284874501006751806324568406;
    uint256 private constant VK_QM_COM_Y =
        1522093955203686116281629526048034563543666750312611984631281801989604375093;
    uint256 private constant VK_QO_COM_X =
        18116824637133877774109916770339012329893346672063455581152619443461705941258;
    uint256 private constant VK_QO_COM_Y =
        12065546623891456568116583509565259597148533132778310848302637027619241642160;
    uint256 private constant VK_QK_COM_X =
        13141440805370550747455201471324318730010929401231584161046984899369324303111;
    uint256 private constant VK_QK_COM_Y =
        12213720583880706739223964024508346683319146975553789702175775841006924916084;

    uint256 private constant VK_S1_COM_X =
        12793975975635479749073429864966625606798501224471844064009199522695564922740;
    uint256 private constant VK_S1_COM_Y =
        8132923293671412095334718058521033016410241972572274691532700944443498103422;

    uint256 private constant VK_S2_COM_X =
        21657378963874914616650592302460330003572962134736577570012568301070663363623;
    uint256 private constant VK_S2_COM_Y =
        1718513843029691644222560949246389014329795284083891303459043520417235854191;

    uint256 private constant VK_S3_COM_X =
        20415325187354694665500244845769422238048526183908185443188703734475579190071;
    uint256 private constant VK_S3_COM_Y =
        18073955099179029460825044425464668031894304571793555401967621518843518905026;

    uint256 private constant VK_COSET_SHIFT = 5;

    uint256 private constant VK_QCP_0_X =
        12741358679119216268442671261008764468184354452248089481320165441775601729818;
    uint256 private constant VK_QCP_0_Y =
        9936318890363003735758197368031202024870521212376882419342977488108314073196;
