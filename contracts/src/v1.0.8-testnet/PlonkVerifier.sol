...
contract PlonkVerifier {
    ...
    uint256 private constant VK_QL_COM_X =
        14585543372410019003092143328009702539190296007679404836599959939969866838166;
    uint256 private constant VK_QL_COM_Y =
        17722824277917999366546751581516521560604709882619404516618901119648408567644;
    uint256 private constant VK_QR_COM_X =
        10898091116425734967678806357954804971805650318410260176362236603111593070946;
    uint256 private constant VK_QR_COM_Y =
        2924038286053928979399281209882141482034634465096220233633728805460582456630;
    uint256 private constant VK_QM_COM_X =
        2031048125815750610347533979665341648587796766028921135553237592603463331141;
    uint256 private constant VK_QM_COM_Y =
        8155065622593766679535254109229393197593220466268704577946828046842494239503;
    uint256 private constant VK_QO_COM_X =
        5947740093533960953767408143123646997500725355604419790528882338800927905402;
    uint256 private constant VK_QO_COM_Y =
        16526622583078899807158771486725089129936075882133814996745054899696208585050;
    uint256 private constant VK_QK_COM_X =
        119740621302450787001135488439015439349927647665033252743058387575629283276;
    uint256 private constant VK_QK_COM_Y =
        13024371462468475459400360697703527331499004139216279341600910316411324286861;

    uint256 private constant VK_S1_COM_X =
        10627327753818917257580031743580923447218792977466576262416509126412843282369;
    uint256 private constant VK_S1_COM_Y =
        18778204069629010711726992370860512366080746441266922837923685723716465874545;

    uint256 private constant VK_S2_COM_X =
        4133742905916748837494066704724945614644731246453049829981019280272507803398;
    uint256 private constant VK_S2_COM_Y =
        6466467061148402844596596206135529025731346998429306278744231736980842648921;

    uint256 private constant VK_S3_COM_X =
        8901602721884560254777014558991324752661207925612502603937647267620946902478;
    uint256 private constant VK_S3_COM_Y =
        2765992643976542253368180121378505606157970815510675049234608868732339659772;

    uint256 private constant VK_COSET_SHIFT = 5;

    uint256 private constant VK_QCP_0_X =
        12771699097177619500468137065083938574724179973377295854993624477225534222388;
    uint256 private constant VK_QCP_0_Y =
        5757719256900570664017938361173180574878811923841521668906048492539193870622;

    uint256 private constant VK_INDEX_COMMIT_API_0 = 32440323;
