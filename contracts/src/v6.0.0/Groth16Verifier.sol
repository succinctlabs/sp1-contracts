...
contract Verifier {
    ...
    uint256 constant DELTA_NEG_X_0 = 4004275305394991690401699166947905504322616158750618602690358508564456424881;
    uint256 constant DELTA_NEG_X_1 = 21318267006432192423091684668879550914883307165248088097282934538626958195450;
    uint256 constant DELTA_NEG_Y_0 = 18101978808364220856809604870476495224053652906079205058649321198153260849699;
    uint256 constant DELTA_NEG_Y_1 = 10235303388765035867992686749968523977022959456183057976818755859873440892741;
    ...
    function publicInputMSM(uint256[5] calldata input) internal view returns (uint256 x, uint256 y) {
    ...
    function verifyCompressedProof(uint256[4] calldata compressedProof, uint256[5] calldata input) public view {
