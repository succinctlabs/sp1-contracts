...
contract PlonkVerifier {
  ...
  uint256 private constant VK_QL_COM_X = 20977342097829807171225062281537045057144477279171603195072021119814866985339;
  uint256 private constant VK_QL_COM_Y = 17685590547516851281238193148890360173330008133674379281809523162297788920724;
  uint256 private constant VK_QR_COM_X = 12638055885120899151728208694856962110433044303106314682530075185050015014679;
  uint256 private constant VK_QR_COM_Y = 16390679248953182031873905552036277830898395925060120021737886684531097372310;
  uint256 private constant VK_QM_COM_X = 3026906881343367302615656083317652915845607560496587458622903128862239864588;
  uint256 private constant VK_QM_COM_Y = 11917175317660663005431736162945590824054112987213362606945128514880998762920;
  uint256 private constant VK_QO_COM_X = 8959791977720189892622669490972021294131107929489935114225894974257713114670;
  uint256 private constant VK_QO_COM_Y = 15956310145449277513870926188219318537317515260791495386805344860746726468894;
  uint256 private constant VK_QK_COM_X = 1660477722391032742152698828793541718951931235551382109645656303090708328624;
  uint256 private constant VK_QK_COM_Y = 12185564102718937798251720613402848918273410936606108499809271969528216025063;
  
  uint256 private constant VK_S1_COM_X = 210697083453268828566716290038870215442471338420359274690344058831985474109;
  uint256 private constant VK_S1_COM_Y = 2921965844753541087752883191114121932456981697943727627386549618326387865659;
  
  uint256 private constant VK_S2_COM_X = 11151359900721879382475663843256076986062427717714092766098070572781442360147;
  uint256 private constant VK_S2_COM_Y = 19848652658087852645284072475690153738640482871860746152214061872068142587241;
  
  uint256 private constant VK_S3_COM_X = 12760844906798187898337228777169926886040048087244774146495979157811645097934;
  uint256 private constant VK_S3_COM_Y = 12242582517927613530082405586347609231008636448791959424122715140008247712940;
  
  uint256 private constant VK_COSET_SHIFT = 5;
  
  
  uint256 private constant VK_QCP_0_X = 10463930653334495879653021384179332232180749357166915295430799675370455028133;
  uint256 private constant VK_QCP_0_Y = 4285131146595933351577512338044664372491931833360113168688005173754836304758;
  
  
  uint256 private constant VK_INDEX_COMMIT_API_0 = 28657785;
